...
try:
    ...
    if not narrative:
        ...
        with open("README.md", "w") as readme_file:
            readme_file.write("# Happiness Data Analysis\n\n")
            readme_file.write("## Data Overview\n")
            readme_file.write("### Dataset Description\n")
            readme_file.write(f"{summary['shape']} rows and {len(summary['columns'])} columns.\n")
            readme_file.write(f"Columns: {', '.join(summary['columns'])}\n")
            readme_file.write("\n## Key Insights\n")
            readme_file.write(narrative)  # Full detailed insights
            readme_file.write("\n## Visualizations\n")
            readme_file.write("![Boxplot](boxplot.png)\n")
            readme_file.write("![Heatmap](correlation_heatmap.png)\n")
        
        print("Narrative successfully saved to 'README.md'.")
